  ...
  return (
    <div id="inicio" className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-96">
      <div className="col-span-1 md:col-span-3 flex flex-col items-center px-4">
        <h2
          className={`${titleClass} ${textBaseClass} hover:translate-x-1 transition duration-300`}
        >
      ...
      <div className="col-span-1 md:col-span-1 flex justify-center">
        <Image
          className={`${style.Image} w-48 h-72 sm:w-72 sm:h-72 md:w-96 md:h-96 lg:w-auto lg:h-auto`}
          src={ImagenMia}
          alt="Mi Foto"
          width={1200}
          height={1200}
      ...
      <div className={`col-span-1 md:col-span-1 ${containerClass}`}>
        <p
          className={`${textBaseClass} ${descriptionClass} mb-5 text-center lg:text-left mt-10`}
        >
